...
class Model(nn.Module):
    ...
    def topK_genrate(self, hidden_states, input_ids, head, nodes, threshold=0.5, max_depth=10,print_time=False):
        ...
        while True:
            ...
            out_hidden, past_key_values = self(hidden_states, input_ids=input_ids,tree_attention_mask=tree_attention_mask_with_kv,
                                               past_key_values=past_key_values,
                                               position_ids=position_ids-1, use_cache=True)
